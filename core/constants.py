...
# ITEMS TYPE PERSON
CODE_TYPE_PERSON_NATURAL = 'PERS-1'
CODE_TYPE_PERSON_JURIDICAL = 'PERS-2'
SIS_TYPE_PERSON_NATURAL_STRING = (CODE_TYPE_PERSON_NATURAL, _('Natural'))
SIS_TYPE_PERSON_JURIDICAL_STRING = (CODE_TYPE_PERSON_JURIDICAL, _('Juridical'))

TYPE_PERSON_OPTIONS = (
    SIS_TYPE_PERSON_NATURAL_STRING, SIS_TYPE_PERSON_JURIDICAL_STRING
)
...
CODE_CORRELATIVE_ITEM1 = 'CRT-1'
CODE_CORRELATIVE_ITEM2 = 'CRT-2'
CODE_CORRELATIVE_ITEM3 = 'CRT-3'
CODE_CORRELATIVE_ITEM4 = 'CRT-4'
SIS_CORRELATIVE_STRING1 = (CODE_CORRELATIVE_ITEM1, _('Factura'))
SIS_CORRELATIVE_STRING2 = (CODE_CORRELATIVE_ITEM2, _('Boleta'))
SIS_CORRELATIVE_STRING3 = (CODE_CORRELATIVE_ITEM3, _('Cotizacion'))
SIS_CORRELATIVE_STRING4 = (CODE_CORRELATIVE_ITEM4, _('Checklist'))
...
SIS_STATUS_FILE_RECORD_NEGATIVE_STRING = (STATUS_FILE_RECORD_NEGATIVE, _('Negativo'))
SIS_STATUS_FILE_RECORD_POSITIVE_STRING = (STATUS_FILE_RECORD_POSITIVE, _('Positivo'))
