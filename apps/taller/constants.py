...
SIS_STATUS_NULL_STRING = (CODE_STATUS_NULL, _('N/A'))
STATUS_VEHICLE_OPTIONS = (
    SIS_STATUS_RENTED_STRING, SIS_STATUS_MAINTENANCE_STRING,
    SIS_STATUS_AVAILABLE_STRING, SIS_STATUS_NULL_STRING
)
